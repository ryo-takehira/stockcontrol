                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="isAdmin" id="isAdmin">
                            ...
                            <option value="2" {{ $user->isAdmin == 2 ? 'selected' : '' }}>事務所</option>
                            <option value="3" {{ $user->isAdmin == 3 ? 'selected' : '' }}>CAD室</option>
                            <option value="4" {{ $user->isAdmin == 4 ? 'selected' : '' }}>第一工場</option>
                            <option value="5" {{ $user->isAdmin == 5 ? 'selected' : '' }}>第二工場</option>
                            <option value="6" {{ $user->isAdmin == 6 ? 'selected' : '' }}>第三工場</option>
                            <option value="7" {{ $user->isAdmin == 7 ? 'selected' : '' }}>第四工場</option>
                            <option value="8" {{ $user->isAdmin == 8 ? 'selected' : '' }}>発送</option>
                        </select>
                    </div>
                </div>
